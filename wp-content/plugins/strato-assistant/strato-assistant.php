...
class Strato_Assistant {
	...
	public function __construct() {
		...
		Strato_Assistant_Handler_Login::init(
			Strato_Assistant_Config::feature( 'login_redesign' )
		);
	...
	public function load_textdomain() {
		if ( strato_is_must_use_plugin_folder() ) {
	...
	public static function get_market() {
		...
		$market = ( string ) strtoupper( get_option( 'strato_assistant_market', $default_market ) );

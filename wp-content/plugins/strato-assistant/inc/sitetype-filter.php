...
/**
 * Class Strato_Assistant_Sitetype_Filter
...
class Strato_Assistant_Sitetype_Filter {
	...
	/**
	 * Strato_Assistant_Sitetype_Filter constructor.
	 *
	...
	function __construct( $config_paths = null, $market = null, $use_transient = true ) {
		...
		if ( is_array( $config_paths ) ) {
			...
			$this->config_paths = array(
				'sitetypes' => Strato_Assistant::get_plugin_dir_path() . 'config/sitetypes.json',
				'plugins'   => Strato_Assistant::get_plugin_dir_path() . 'config/plugins.json'
			);
		}
		...
		if (! empty( $market ) ) {
			...
			$this->market = Strato_Assistant::get_market();
		}

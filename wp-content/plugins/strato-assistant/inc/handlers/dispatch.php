...
class Strato_Assistant_Handler_Dispatch {
	...
	public static function admin_init() {
		...
		add_action( 'customize_controls_print_footer_scripts', array( 'Strato_Assistant_Handler_Dispatch', 'add_customizer_thickbox' ) );
		...
		add_action( 'wp_ajax_ajaxinstall', array( 'Strato_Assistant_Handler_Dispatch', 'install_plugins_and_themes' ) );
	...
	public static function install_plugins_and_themes() {
		...
		$sitetype_transient = 'strato_assistant_process_sitetype_user_' . get_current_user_id();
		$theme_transient = 'strato_assistant_process_theme_user_' . get_current_user_id();
	...
	public static function enqueue_assistant_scripts() {
		...
		if ( self::is_assistant_admin_page() || self::is_customizer_page( 'congrats' ) ) {
			...
			wp_enqueue_script( 'strato-assistant', Strato_Assistant::get_js_url( 'assistant.js' ), array( 'jquery', 'wp-util' ), false, true );

		...
		<div id="card-congrats" class="card-step">
			...
			<div class="card-content">
				<div class="card-content-inner">
					<h2><?php esc_html_e( 'setup_assistant_customizer_title', 'strato-assistant' ) ?></h2>
					<p><?php _e( 'setup_assistant_customizer_desc1', 'strato-assistant' ); ?></p>
					<p><?php _e( 'setup_assistant_customizer_desc2', 'strato-assistant' ); ?></p>
				</div>
			</div>
			...
			<?php
				Strato_Assistant_View::load_template( 'card/footer', array(
					'card_actions' => array(
						...
						'right' => array(
							'skip-congrats' => array(
								'label'   => esc_html__( 'setup_assistant_customizer_close_button', 'strato-assistant' ),

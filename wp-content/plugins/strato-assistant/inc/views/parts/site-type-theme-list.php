		...
		<?php foreach ( $themes as $theme ): ?>
			...
			<a class="theme" href="#" data-site-type="<?php echo $site_type; ?>" data-theme="<?php echo $theme[ 'id' ]; ?>">
	            ...
	            <span class="theme-thumbnail">
		            ...
		            <?php if ( !empty( $theme['active'] ) ): ?>
			            <span class="theme-btn button"><?php esc_html_e( 'Keep', 'strato-assistant' ) ?></span>
		            <?php else: ?>
			            <span class="theme-btn button button-primary"><?php esc_html_e( 'Install', 'strato-assistant' ) ?></span>
		            <?php endif; ?>
	            </span>
			</a>
		<?php endforeach; ?>

<div id="assistant-german-market-panel" class="dashboard-column dashboard-column1 welcome-panel assistant-dashboard-panel">
	...
	<div class="inside">
		<figure class="full-width">
			<img src="<?php echo Strato_Assistant::get_images_url( 'dashboard/wp-german-market.png' ) ?>" alt="German market + WooCommerce" />
		</figure>
		<div class="dashboard-panel-title woocommerce-message">
			<h2><?php _e( 'Legally compliant with your WooCommerce, in German and EU markets.', 'strato-assistant' ); ?></h2>
            <a class="button button-primary install-plugin" data-plugin="german-market" href="#">
                <span class="setup"><?php _e( 'Setup German Market', 'strato-assistant' ); ?></span>
            ...
            <a class="learn-more-link" target="_blank" href="https://www.youtube.com/watch?v=spYbS4MACzI">
                <?php _e( 'Learn more', 'strato-assistant' ); ?>
            </a>
		</div>
	</div>
</div>
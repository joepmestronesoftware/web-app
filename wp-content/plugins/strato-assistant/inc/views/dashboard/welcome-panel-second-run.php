<?php
    $blog_url = Strato_Assistant_Config::get( 'blog_{market}', 'links', 'blog_US' );
    $cp_applications_url = Strato_Assistant_Config::get( 'control_panel_applications_{market}', 'links' );
?>

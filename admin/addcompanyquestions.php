...
if(isset($_POST['Submit']) && isset($_GET['CompanyID']))
{
    //print_r($_POST);die;
    $QuestionSetID=0;
    for($i=1; $i<=$_POST['GroupCount']; $i++)
    {
        if($i == 1)
        {
            $insert_qustion_set = mysqli_query($DbConn, "insert into tbl_questionsets set QuestionSetCompanyID='".$_GET['CompanyID']."', QuestionSetStartDate='".addslashes($_POST['QuestionSetStartDate'])."', QuestionSetEndDate='".addslashes($_POST['QuestionSetEndDate'])."'") or die(mysqli_error($DbConn));
            $QuestionSetID = mysqli_insert_id($DbConn);
        }
        if(isset($_POST['QuestionGroupTitle_'.$i]) && !empty($QuestionSetID))
        {
...
<html>
  <head>
    ...
    <title>Add Company Questions- Admin</title>
...
<?php include("includes/leftpanel.php");?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
			<div class="box">
                <?php /*$check_groups = mysqli_query($DbConn, "select * from tbl_questiongroups where QuestionGroupCompanyID=".$_GET['CompanyID']) or die(mysqli_error($DbConn));
                ...
                */?>
                  ...
                  <div class="box-body" id="box-body">
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="QuestionSetStartDate" name="QuestionSetStartDate" required placeholder="Start Date">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                            <label>End Date </label>
                            <input type="text" class="form-control" id="QuestionSetEndDate" name="QuestionSetEndDate" required placeholder="End Date">
                        </div>
                      </div>
                    <?php 
                          $count_group=0;
                      if(isset($_REQUEST['QuestionSetID']))
                      {
                ...
                <div class="box-body">
                    <div class="col-md-12">
                        ...
                        <br>Question already addded for this company. <a href="companies.php" title="Go Back">Go Back</a>
                    </div>
                </div>
                <?php } */?>
              </div>

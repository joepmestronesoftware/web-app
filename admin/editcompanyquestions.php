			...
			<div class="box">
                ...
                <div class="box-body">
                  ...
                  <div class="box-body" id="box-body">
                    ...
                    <?php
                          $count_group=0;
                          $select_groups = mysqli_query($DbConn, "select * from tbl_questiongroups where QuestionSetID='".$_REQUEST['QuestionSetID']."' ORDER BY ABS(QuestionGroupID) ASC") or die(mysqli_error($DbConn));
                      ...
                      <?php if($count_group != 1){?>
                          ...
                          <?php 
                              $select_questions = mysqli_query($DbConn, "select * from tbl_questions where QuestionGroupID='".$groupinfo->QuestionGroupID."' ORDER BY ABS(QuestionID) ASC") or die(mysqli_error($DbConn));
